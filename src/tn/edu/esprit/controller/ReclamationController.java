...
public class ReclamationController implements Initializable {
    ...
    private void rechercher(KeyEvent event) throws SQLException {
        ...
        for(int i = 0; i < Iu.recherche(searchbox.getText()).size(); ++i) {
            ...
            FXMLLoader load = new FXMLLoader(this.getClass().getResource("/tn/edu/esprit/gui/Unereclamation.fxml"));
    ...
    private void to_Typereclamation(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/edu/esprit/gui/Typereclamation.fxml"));
        fxml = loader.load();
    ...
    private void to_stat(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/edu/esprit/gui/Statistique.fxml"));
        fxml = loader.load();
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        scene = new Scene(fxml);
        scene.setFill(Color.TRANSPARENT);
